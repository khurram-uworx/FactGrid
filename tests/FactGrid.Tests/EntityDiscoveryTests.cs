...
public class EntityDiscoveryTests
{
    ...
    public void GetEntityList_ReturnsAllRegistrations()
    {
        ...
        Assert.That(ex.DisplayName, Is.EqualTo("Expenses"));
        Assert.That(ex.TableName, Is.EqualTo("Expenses"));
    }
    ...
    public void GetEntityList_SerializesToExpectedShape()
    {
        ...
        Assert.That(expenses.GetProperty("displayName").GetString(), Is.EqualTo("Expenses"));
        Assert.That(expenses.GetProperty("table").GetString(), Is.EqualTo("Expenses"));
    }
